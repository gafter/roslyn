...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class DefiniteAssignmentPass : LocalDataFlowPass<DefiniteAssignmentPass.LocalState>
    {
        ...
        protected virtual void ReportUnassigned(Symbol symbol, SyntaxNode node, int slot, bool skipIfUseBeforeDeclaration)
        {
            ...
            else if (!_alreadyReported[slot] && !symbol.GetTypeOrReturnType().IsErrorType())
            {
        ...
        private bool FieldsAllSet(int containingSlot, LocalState state)
        {
            ...
            TypeSymbol structType = variable.Symbol.GetTypeOrReturnType().TypeSymbol;
        ...
        private void SetSlotAssigned(int slot, ref LocalState state)
        {
            ...
            TypeSymbol type = id.Symbol.GetTypeOrReturnType().TypeSymbol;
