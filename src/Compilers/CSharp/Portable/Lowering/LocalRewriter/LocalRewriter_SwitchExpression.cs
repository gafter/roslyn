...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalRewriter
    {
        ...
        {
            var rewriter = new SwitchExpressionLocalRewriter(this, node);
        ...
        private class BaseSwitchLocalRewriter : PatternLocalRewriter
        {
            ...
            /// _backwardLabels.
            /// PROTOTYPE(patterns2): This is a placeholder for planned work. It is not populated or used yet.
            /// </summary>
            protected readonly ArrayBuilder<LabelSymbol> _backwardLabels = ArrayBuilder<LabelSymbol>.GetInstance();
            ...
            /// and the label. This is prepopulated with the set of decision dag nodes that have more than one
            /// predecessor.
            /// PROTOTYPE(patterns2): This is a placeholder for planned work. It is not populated or used yet.
            /// </summary>
            protected readonly HashSet<BoundDecisionDag> _labelRequired = new HashSet<BoundDecisionDag>();
            ...
            public BaseSwitchLocalRewriter(LocalRewriter localRewriter, BoundExpression loweredInput)
        ...
        {
            public SwitchExpressionLocalRewriter(LocalRewriter localRewriter, BoundSwitchExpression node)
                : base(localRewriter, localRewriter.VisitExpression(node.Expression))
            {
                foreach (var section in node.SwitchArms)
                {
                    _switchArms.Add(section.Syntax, ArrayBuilder<BoundStatement>.GetInstance());
                }
            }

            internal BoundExpression LowerSwitchExpression(BoundSwitchExpression node)
            {
