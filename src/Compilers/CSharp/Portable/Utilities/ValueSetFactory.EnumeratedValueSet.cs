    ...
    internal static partial class ValueSetFactory
    {
        ...
        private sealed class EnumeratedValueSet<T, TTC> : IValueSet<T> where TTC : struct, EqualableValueTC<T>
        {
            ...
            public IValueSet<T> Intersect(IValueSet<T> o)
            {
                ...
                {
                    case (true, true):
                        return new EnumeratedValueSet<T, TTC>(true, this._membersIncludedOrExcluded.Intersect(other._membersIncludedOrExcluded));
                    case (true, false):
                        return new EnumeratedValueSet<T, TTC>(true, this._membersIncludedOrExcluded.Except(other._membersIncludedOrExcluded));
                    case (false, false):
                        return new EnumeratedValueSet<T, TTC>(false, this._membersIncludedOrExcluded.Union(other._membersIncludedOrExcluded));
                    case (false, true):
                        return new EnumeratedValueSet<T, TTC>(true, other._membersIncludedOrExcluded.Except(this._membersIncludedOrExcluded));
                }
            }
            ...
            public IValueSet<T> Union(IValueSet<T> o)
            {
                ...
                {
                    case (false, false):
                        return new EnumeratedValueSet<T, TTC>(false, this._membersIncludedOrExcluded.Intersect(other._membersIncludedOrExcluded));
                    case (false, true):
                        return new EnumeratedValueSet<T, TTC>(false, this._membersIncludedOrExcluded.Except(other._membersIncludedOrExcluded));
                    case (true, true):
                        return new EnumeratedValueSet<T, TTC>(true, this._membersIncludedOrExcluded.Union(other._membersIncludedOrExcluded));
                    case (true, false):
                        return new EnumeratedValueSet<T, TTC>(false, other._membersIncludedOrExcluded.Except(this._membersIncludedOrExcluded));
                }
            }
