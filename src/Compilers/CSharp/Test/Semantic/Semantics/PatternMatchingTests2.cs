...
namespace System
{
    public struct ValueTuple<T1, T2>
    {
        ...
        [Fact]
        public void PROTOTYPE_patterns2()
        {
            // PROTOTYPE(patterns2): This produces bad code. I don't know why, so I crafted this "minimal" repro.
            var source =
@"
class Program
{
...
";
            ...
            var comp = CompileAndVerify(compilation, expectedOutput: "test");
        }
